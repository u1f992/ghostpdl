...
// }
{
   ...
   */
  const src = path.resolve(__dirname, "../arch/windows-x86-msvc.h");
  const dest = path.resolve(__dirname, "../arch/wasm32-unknown-emscripten.h");
...

{
   ...
   */
  const target = path.resolve(__dirname, "../base/gxfapi.h");
